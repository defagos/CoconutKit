...
@interface AnimationDemoViewController : HLSViewController <HLSAnimationDelegate> {
@private
    UIView *m_rectangleView1;
    UIView *m_rectangleView2;
    UIView *m_rectangleView3;
    UIView *m_rectangleView4;
    UIView *m_rectangleView5;
...
@property (nonatomic, retain) IBOutlet UIView *rectangleView5;
