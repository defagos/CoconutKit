...
struct _HLSNativeZWRTableEntry { BOOL isTable; void *ptr; };
static struct _HLSNativeZWRTableEntry _MAZeroingWeakRefClassNativeWeakReferenceNotAllowedTable[256] = {
    ...
    [0x5] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
    ...
    [0x7] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
    ...
    [0x1a] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
    ...
    [0x1f] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
    ...
    [0x37] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
    ...
    [0x3a] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
    ...
    [0x4a] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
    ...
    [0x4e] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
    ...
    [0x54] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
    ...
    [0x5f] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
    ...
    [0x6a] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
    ...
    [0x6f] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
    ...
    [0x7f] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
    ...
    [0x95] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
    ...
    [0x98] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
    ...
    [0xbe] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
    ...
    [0xcd] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
    ...
    [0xdc] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
    ...
    [0xdd] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
    ...
    [0xde] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
    ...
    [0xe8] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
    ...
    [0xf1] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
    ...
    [0xf3] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
    ...
    [0xfc] = { 1, (struct _HLSNativeZWRTableEntry[256]) { // 1
