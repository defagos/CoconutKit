 ...
 * will always be combined with those generated by the manually implemented validations. In general,
 * though, I strongly suggest implementing validations for all fields using one of the following rules
 * exclusively:
