 ...
 *   - drop a view controller onto the storyboard, and set its class to HLSStackController
 *   - drop another view controller onto the storyboard, and set it as root view controller of the stack by
 *     binding the stack controller with it using an HLSStackPushSegue called 'root'
