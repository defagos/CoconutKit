...
+ (void)load
{
    s_UIActionSheet__showFromToolbar_Imp = (void (*)(id, SEL, id))hls_class_swizzle_selector(self, 
                                                                                             @selector(showFromToolbar:), 
                                                                                             (IMP)swizzled_UIActionSheet__showFromToolbar_Imp);
    s_UIActionSheet__showFromTabBar_Imp = (void (*)(id, SEL, id))hls_class_swizzle_selector(self, 
                                                                                            @selector(showFromTabBar:), 
                                                                                            (IMP)swizzled_UIActionSheet__showFromTabBar_Imp);
    s_UIActionSheet__showFromBarButtonItem_animated_Imp = (void (*)(id, SEL, id, BOOL))hls_class_swizzle_selector(self, 
                                                                                                                  @selector(showFromBarButtonItem:animated:), 
                                                                                                                  (IMP)swizzled_UIActionSheet__showFromBarButtonItem_animated_Imp);
    s_UIActionSheet__showFromRect_inView_animated_Imp = (void (*)(id, SEL, CGRect, id, BOOL))hls_class_swizzle_selector(self,
                                                                                                                        @selector(showFromRect:inView:animated:), 
                                                                                                                        (IMP)swizzled_UIActionSheet__showFromRect_inView_animated_Imp);
    s_UIActionSheet__showInView_Imp = (void (*)(id, SEL, id))hls_class_swizzle_selector(self, 
                                                                                        @selector(showInView:), 
                                                                                        (IMP)swizzled_UIActionSheet__showInView_Imp);
    s_UIActionSheet__dismissWithClickedButtonIndex_animated_Imp = (void (*)(id, SEL, NSInteger, BOOL))hls_class_swizzle_selector(self,
