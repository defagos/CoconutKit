...
+ (void)load
{
    s_UINavigationBar__insertSubview_atIndex_Imp = (void (*)(id, SEL, id, NSInteger))hls_class_swizzle_selector(self, 
                                                                                                                @selector(insertSubview:atIndex:), 
                                                                                                                (IMP)swizzled_UINavigationBar__insertSubview_atIndex_Imp);
    s_UINavigationBar__insertSubview_belowSubview_Imp = (void (*)(id, SEL, id, id))hls_class_swizzle_selector(self, 
                                                                                                              @selector(insertSubview:belowSubview:), 
                                                                                                              (IMP)swizzled_UINavigationBar__insertSubview_belowSubview_Imp);
    s_UINavigationBar__sendSubviewToBack_Imp = (void (*)(id, SEL, id))hls_class_swizzle_selector(self, 
