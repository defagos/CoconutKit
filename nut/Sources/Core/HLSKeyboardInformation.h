 ...
 * object. If this object is not nil, then the keyboard is visible (or soon will) and you can get check its properties.
 *
...
/**
 * Return the keyboard information if displayed (or about to be displayed), nil if the keyboard is not visible
 * or about to be hidden
 */
